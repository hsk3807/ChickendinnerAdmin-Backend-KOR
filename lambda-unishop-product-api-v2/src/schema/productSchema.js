...
const _baseSchema = {
    ...
    down_category_id: Joi.number().allow(null).optional(),
    category_id: Joi.number().allow(null).optional(),
    item_desc: Joi.string().allow('').optional(),
    item_link: Joi.string().allow('').optional(),
    is_pack: Joi.boolean().optional(),
    is_new: Joi.boolean().optional(),
    is_best: Joi.boolean().optional(),
    is_soldout: Joi.boolean().optional(),
    is_visible: Joi.boolean().optional(),
    max_order_cnt: Joi.number().allow(null).optional(),
    is_delay_chk: Joi.boolean().optional(),
    delay_phrase: Joi.string().allow('').optional(),

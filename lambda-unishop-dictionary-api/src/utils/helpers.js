...
const extractSortings = (qsParams, prefix) => extractQueryStringGroup(qsParams, prefix)

const generateChecksum = stringValue => uuidV5(stringValue, '1b671a64-40d5-491e-99b0-da01ff1f3341')
